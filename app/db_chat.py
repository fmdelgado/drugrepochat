...
class bot_message:
    ...
    def update(self, text):
        message = f"""<div style='display:flex;align-items:center;margin-bottom:10px;'>
                    <img src='https://github.com/fmdelgado/drugrepochat/blob/fix-bugs-db-update/app/img/logo.png' style='width:50px;height:50px;border-radius:50%;margin-right:10px;'>
